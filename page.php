          ...
          <div class="col-lg-12">
            <div class="section-header-title">
              <div class="section-header-title-bg">
                ...
                <a href="#" class="btn" id="btn">Заказать</a>
              </div>            
            </div>
          </div>
              ...
              <div class="section-form clearfix">
                ...
                <div class="col-lg-4 col-md-6 col-xs-12 col-xs-offset-0 col-lg-offset-3">
                  <form class="form-submit" id="form">
                    <input class="form-name" type="text" name="name" placeholder="Ваше имя">
                    <input class="form-tel" type="text" name="phone" placeholder="Ваш номер телефона">
